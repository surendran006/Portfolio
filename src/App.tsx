        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.div 
                whileHover={{ scale: 1.02, y: -5 }}
                className="p-10 bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl border border-purple-100 shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-2xl mb-2">Digital Marketing Course</h4>
                    <p className="text-xl text-gray-600 mb-4">Inspire Digital Marketing</p>
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-5 h-5 text-green-500" />
                      <span className="text-sm text-green-600 font-medium">Certified Professional</span>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div 
                whileHover={{ scale: 1.02, y: -5 }}
                className="p-10 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl border border-yellow-100 shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                ...
                <p className="text-gray-700 italic mb-4 text-lg leading-relaxed">
                  "Surendran's expertise in digital marketing has significantly improved our online presence and sales performance."
                </p>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-800">Client Feedback</div>
